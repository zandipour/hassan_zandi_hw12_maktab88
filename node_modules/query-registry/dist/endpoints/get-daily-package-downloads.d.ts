 ...
 */
export declare function getDailyPackageDownloads({ name, period: rawDownloadPeriod, registryDownloadsAPI, cached, }: {
    name: string;
    period?: DownloadPeriod;
    registryDownloadsAPI?: string;
    cached?: boolean;
}): Promise<DailyPackageDownloads>;
//# sourceMappingURL=get-daily-package-downloads.d.ts.map