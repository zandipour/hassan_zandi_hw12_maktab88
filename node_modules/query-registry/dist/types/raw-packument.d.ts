 ...
 * @see {@link https://github.com/npm/registry/blob/master/docs/responses/package-metadata.md#full-metadata-format}
 */
export declare type HoistedPackageJSON = Pick<PackageJSON, 'author' | 'bugs' | 'contributors' | 'description' | 'homepage' | 'keywords' | 'license' | 'maintainers' | 'readme' | 'readmeFilename' | 'repository'>;
//# sourceMappingURL=raw-packument.d.ts.map